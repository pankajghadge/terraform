...
variable "instance_count" {
  description = "Total instances under ELB"
  default     = 2
}

variable "images_instance_count" {
  description = "Total image instances under ALB"
  default     = 1
}

variable "videos_instance_count" {
  description = "Total video instances under ALB"
  default     = 1
}
